...
export function CurrencyInput(props) {
    ...
    return (_jsxs("div", { onClick: handleFocus, className: styles.group({ radii, size, space, spacing, variant }), style: {
            ...
            ...style,
        }, children: [Icon && (_jsx(Icon, { size: iconSize, strokeWidth: iconStrokeWidth, color: colorIcon })), _jsx("input", { ref: inputRef, onFocus: () => setIsFocused(true), onBlur: () => setIsFocused(false), name: name, onKeyDown: handleKeyDown, value: forcedValue || valueDisplay(value), id: id || inputId, className: styles.container({ fontSize, fontWeight }), ...rest })] }));
}
