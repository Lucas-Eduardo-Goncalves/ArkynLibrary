...
export function ImageUploader(args) {
    ...
    const { colorScheme, bg, iconColorScheme, fontSize, changeError, fontWeight, radii, size, space, spacing, variant, responseFileName = "file_url", style, uploadUrl, onChange = () => { }, ...rest } = { ...args, ...button };
    const { borderColor = "var(--neutral-700)", buttonText = "Selecionar Imagem", changeImageButtonText = "Alterar imagem", dragText = "Ou arraste e solte a imagem aqui", onDrop = () => { }, imageSize = { h: 300, w: 400 }, name = "file", iconSize = 40, iconColor = "var(--neutral-500)", defaultValue, setLoading = () => { }, isError, } = args;
