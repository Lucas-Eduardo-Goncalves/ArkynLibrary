...
export function Simple(props) {
    const { id, fontSize = "md", fontWeight = "regular", spacing = "sm", radii = "md", size = "md", space = "sm", variant = "default", colorScheme = "indigo", icon: Icon, iconSize = 20, iconStrokeWidth = 2, iconColor = "var(--slate-400)", name, style, bg, type, ...rest } = props;
